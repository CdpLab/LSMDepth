...
class LightOptions:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description="Light options")

        # PATHS
        self.parser.add_argument("--data_path",
                                 type=str,
                                 help="path to the training data",
                                 default=os.path.join(file_dir, "D:/dataset/kitti_rawdata"))
        ...
        self.parser.add_argument("--model",
                                 ...
                                 choices=["light", "light-s", "light-t", "light-m"],
                                 default="light")
